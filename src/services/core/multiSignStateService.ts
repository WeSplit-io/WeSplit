...
let _multiSignStateService: MultiSignStateService | null = null;

export const multiSignStateService = {
  get instance() {
    if (!_multiSignStateService) {
      _multiSignStateService = new MultiSignStateService();
    }
    return _multiSignStateService;
  }
};